...
Release history lives in **[CHANGELOG.md](CHANGELOG.md)** (Keep-a-Changelog format, one section per annotated git tag). See that file for the per-version delta; this document focuses on the original design and scope.
